{
  ...
  # imported ./nix modules. This project is dev-shell-only (the package and its
  # dependencies are built with cabal inside the shell), so there is no
  # flake.module.nix package build.
